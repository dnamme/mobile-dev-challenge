            ...
            child: new Column(
              ...
              children: [
                ...
                new SingleChildScrollView(
                    ...
                    child: new Padding(
                        padding: EdgeInsets.fromLTRB(12.5, 12.5, 0.0, 12.5),
                        child: new Row(children: [
                          new Container(
                              decoration: BoxDecoration(
                                  color: Color(0xff2d384c),
                          ...
                          new Container(
                              ...
                              child: new Column(
                                ...
                                children: [
                                  new Stack(children: [
                                    new Image.asset('assets/img/Rat_Drops.png',
                                        width: 90.0 / 253 * 516,
                                        height: 90.0,
                                        fit: BoxFit.fill),
                                    Positioned(
                        ...
                        child: new Row(children: [
                          new Container(
                              ...
                              child: new Column(
                                ...
                                children: [
                                  new Stack(children: [
                                    new Image.asset('assets/img/Koi_Desuu.png',
                                        height: 90.0),
                                    Positioned(
                                        top: 3.0,
                                        right: 7.5,
            ...
            child: new Row(
              ...
              children: [
                new Column(
                  ...
                  children: [
                    new Image.asset('assets/icons/discover.png', width: 28.0),
                    new Text('Discover',
                        style: GoogleFonts.roboto(
                            color: Color(0xff2d384c),
                            fontSize: 12.5,
                ...
                new Column(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    new Image.asset('assets/icons/profile.png', width: 27.5),
                    new Text('Profile',
                        style: GoogleFonts.roboto(
                            color: Color(0xffc2c2c2),
                            fontSize: 12.5,
